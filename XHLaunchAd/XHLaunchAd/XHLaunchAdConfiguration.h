...
/** 设置skipButton 的frame */
@property(nonatomic, assign) CGRect skipButtonFrame;
...
@property(nonatomic, copy) NSString *openURLString XHLaunchAdDeprecated(
    "请使用openModel,点击事件代理方法请对应使用xhLaunchAd:clickAndOpenModel:"
    "clickPoint:");
...
/** 设置GIF动图是否只循环播放一次(YES:只播放一次,NO:循环播放,default
 * NO,仅对动图设置有效) */
...
@property(nonatomic, assign)
    MPMovieScalingMode scalingMode XHLaunchAdDeprecated("请使用videoGravity");
